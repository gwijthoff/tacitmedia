...
Even-numbered weeks will be devoted to recent scholarship on digital media and culture, with an emphasis on emerging approaches to questions of selfhood (privacy, habit, boredom, intimacy), inequality (biased algorithms, digital divides, information illiteracy), and the public (bots, fake news, filter bubbles, revolution). Altogether, these weeks will provide students with a sense of the "stack" of technologies and policies making up the networked world, from code to interface to device to infrastructure to power.

## odd weeks: paradigms of media studies

Odd-numbered weeks will be devoted to influential concepts from the history of media studies, including theories of cinema spectatorship, technics, and broadcast media that take on new value in understanding and negotiating the ways we live with technology today. Special emphasis will be given to visual media. While the boundaries of media studies are porous, as much as possible we will try to isolate the dominant paradigms.
...
- technique: record a video of yourself making coffee/tea, or something else you do/make every day. 60 sec max. Compare techniques in class.
- [People You May Know Inspector](https://gizmodo.com/keep-track-of-who-facebook-thinks-you-know-with-this-ni-1819422352) by Gizmodo's Special Projects Desk, and the [history of Facebook's efforts to bring the project down](https://gizmodo.com/facebook-wanted-us-to-kill-this-investigative-tool-1826620111)
- [Panopticlick](https://panopticlick.eff.org/) can help you learn more about browser fingerprinting and see which properties of your own browser are used to fingerprint.
...
- André Leroi-Gourhan, *Gesture and Speech* (1993 [1964])
- Friedrich Kittler, *Gramophone, Film, Typewriter* (1999 [1986])
- Miriam Hansen, *Babel and Babylon: Spectatorship in American Silent Film* (1994)
- Hans Ulrich Gumbrecht and Karl Ludwig Pfeiffer, eds. *Materialities of Communication* (1994)
